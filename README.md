...
The goal of Da Pino Restaurant Website is to provide up to date information about the Restaurant Menu, Special Deals available, Wine List, Take Away Deals, Social Media Links, and Reviews from customers. Also provide contact details, address, and location on map, pictures of the Restaurant and of sample dishes available on the menu. The website advertises Group deals, Pre Theatre and Take Away promotions.
...
The Homepage main specials section have a full image on the background with three messages opening on the side: Group Offers, Pre Theatre and Take Away deals.  
...
The Restaurant Owner's goal is to improve business, show potential customers menus and wines available with related prices, pictures of the Restaurant and the dishes, enhance take away and early evening trade. The owner need a website where users can access contact details, phone number, clear address with map location and a contact form for email enquiries. Let the users know that special deals are available for Groups, Christmas Parties, Business Dinners, and Private Functions. Also provide downloadable option for a PDF menu for Offices Parties, Tour Operators or anyone who might need a hard copy of the menu.
...
![](assets/docs/user-stories-screenshots/user-stories5.png)
1. Promote Take Away deal. A section on the Home page informs the user Take Away promotions.  
![](assets/docs/user-stories-screenshots/user-stories6.png) 
1. Show pictures of the Restaurant and the dishes. Pictures will be displayed in the Gallery page.  
![](assets/docs/user-stories-screenshots/user-stories7.png) 
1. Show links to Social Media networks and Trip Advisor.  
![](assets/docs/user-stories-screenshots/user-stories8.png)
1. Display few customer reviews.  
![](assets/docs/user-stories-screenshots/user-stories9.png)
...
* In the mobile view the navigation links shrinks into a toggle icon which is fixed on the top right of the screen staying visible when the user scrolls down the page, for a more user friendly website.
* In the mobile view on the top left there is a map pin linked to Google maps website showing the exact location of the Restaurant in a new tab.
...
* The background of the specials section in the Homepage contains a view of the restaurant. 
* The first message contains a Pre Theatre deal available, by clicking on the enquiry button will go to the contact page.
* The second message promotes possible deals for large parties. By clicking on the button the user will go the the contact page.
...
* Each review contains a small picture of the author, the review title, a five stars rating symbol, the review message and the author's name.
### Footer Features  
* In the footer there are links to Social Media Accounts (Twitter, Facebook, Instagram) also a link to Tripadvisor. When clicked the links open new tabs.
...
## Testing
---
### The website was tested in the following OS:  
Chrome  
Mozilla Firefox  
Internet Explorer  
Android Tablet  
...
1. Description of when the problem occurs.
1. Solution (if found).
1. Description of what should happened instead(if solution is not found).
1. On which OS or screen size the bug happened.
